...
module.exports = function (proto) {
  ...
  /**
   * bind command to EventEmitter (like `http.IncomingMessage`) in order to kill proc with event
   *
   * @param {EventEmitter} emitter
   * @param {Array} events
   * @return {Object} gm
   * @example
   *   command.bindEventEmitter(req, ['close', 'end', 'finish']);
   */

  proto.bindEventEmitter = function bindEventEmitter (emitter, events) {
    var self = this;
